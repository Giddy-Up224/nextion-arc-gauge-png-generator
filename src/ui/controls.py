...
from PySide6.QtWidgets import QMainWindow, QWidget, QPushButton, QHBoxLayout, QVBoxLayout, QCheckBox, QLabel, QSpinBox, QDoubleSpinBox
...
class ArcDesignControls(QGroupBox):
    def __init__(self, title: str):
        ...
        self.arc_width_lbl    = QLabel('Thickness:')
        self.arc_width_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        self.arc_width_fld    = QSpinBox()
        self.arc_width_fld.setValue(10)  
        self.arc_width_fld.setMaximum(100)  
        self.encaps_ckbx      = QCheckBox('Endcaps')
        self.encaps_ckbx.setChecked(True)
        self.color_btn_lbl    = QLabel('Arc Color:')
        self.color_btn_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        self.btn_color        = ColorButton(QColor('#FFFFFF'))
        self.endcap_color_lbl = QLabel('Endcap Color:')
        self.endcap_color_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        ...
        self.start_angle_fld  = QDoubleSpinBox()
        self.start_angle_fld.setMinimum(0.00)
        self.start_angle_fld.setMaximum(359.99)
        self.start_angle_fld.setDecimals(2)
        self.start_angle_fld.setSingleStep(1)
        self.start_angle_fld.setValue(235.00)
        self.end_angle_fld    = QDoubleSpinBox()
        self.end_angle_fld.setMinimum(0.00)
        self.end_angle_fld.setMaximum(359.99)
        self.end_angle_fld.setDecimals(2)
        self.end_angle_fld.setSingleStep(1)
        self.end_angle_fld.setValue(125)
        layout.addWidget(self.arc_width_lbl,    0, 0)
        layout.addWidget(self.arc_width_fld,    0, 1)
        layout.addWidget(self.encaps_ckbx,      0, 2)
        layout.addWidget(self.color_btn_lbl,    1, 0)
        layout.addWidget(self.btn_color,        1, 1)
        layout.addWidget(self.start_angle_lbl,  1, 2)
        layout.addWidget(self.start_angle_fld,  1, 3)
        layout.addWidget(self.endcap_color_lbl, 2, 0)
...
class ArcCountControls(QGroupBox):
    def __init__(self):
        super().__init__()
        self.setTitle('Image Options')
        layout = QGridLayout(self)
        self.increment_val_lbl = QLabel('Increment:')
        self.increment_val_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        self.increment_val_fld = QSpinBox()
        self.increment_val_fld.setValue(1)
        self.increment_val_fld.setMaximum(2000)
        self.number_of_images_lbl = QLabel('No. of Images:')
        self.number_of_images_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
