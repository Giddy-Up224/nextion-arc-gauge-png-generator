...
def venv_exists():
    if os.name == "nt":
        ...
        return os.path.isdir("venv") and os.path.isfile(venv_python)
    else:
...
def main():
    if '--help' in sys.argv:
        ...
        if sys.platform == 'win32':
            ...
            cmd = 'python3'
        print(f"Usage: {cmd} pkg.py [optional]<name-for-your-executable> [optional]<path-to-main.py>")
        print(f"Example: {cmd} pkg.py MyApp src/main.py")
